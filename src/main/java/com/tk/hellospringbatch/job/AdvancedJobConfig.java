...
import com.tk.hellospringbatch.job.validator.LocalDateParameterValidator;
    ...
    public JobExecutionListener jobExecutionListener(){
        return new JobExecutionListener() {
            ...
            public void beforeJob(JobExecution jobExecution) {
                log.info("[JobExecutionLister#beforeJob] jobExecution is " + jobExecution.getStatus());
            ...
            public void afterJob(JobExecution jobExecution) {
                if (jobExecution.getStatus() == BatchStatus.FAILED) {
                    log.error("[JobExecutionLister#afterJob] jobExecution is FAILED!! RECOVER ASAP");
                }
                log.info("[JobExecutionLister#afterJob] jobExecution is " + jobExecution.getStatus());
            }
        };
    }
